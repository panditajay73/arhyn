    ...
    {p.name}
                ...
                <div className="p-6">
                  ...
                  <p className="text-sm text-dim mb-4">
                    <span className="font-mono text-[0.68rem] uppercase tracking-wide text-wire">Problem solved — </span>
                    {p.problem}
                  </p>
                  <div className="flex flex-wrap gap-2">
                    {p.tech.map((t) => (
                      <span key={t} className="rounded-full border border-line px-2.5 py-1 text-[0.68rem] font-mono text-dim">
                        {t}
                      </span>
                    ))}
                  </div>
