...
const serviceCopy = [
  {
    ...
    problem: "Most local businesses either have no website or one that has not been touched since 2016.",
  ...
  },
  {
    ...
    problem: "Manual processes do not scale past a certain point without hiring more people.",
  ...
  {
    title: "SEO",
    problem: "A beautiful website nobody can find is a website that does not work.",
  ...
  },
  {
    ...
    problem: "On-premise systems break, do not scale, and are hard to access remotely.",
  ...
  },
  {
    ...
    benefit: "Data that is finally usable for real decisions, not just storage.",
  },
  {
  ...
  },
  {
    ...
    problem: "Tools that do not talk to each other create duplicate work and errors.",
  ...
  },
  {
    ...
    problem: "Owners make decisions on gut feeling because the data is not visible anywhere.",
...
const projectCopy = [
  {
    description: "Movies and cinematic portfolio platform showcasing premium films.",
    problem: "A premium photography studio had no platform matching the quality of its own work.",
  },
  {
    description: "Developer productivity workspace with AI-powered tools and dashboards.",
    problem: "Engineering workflows were fragmented across multiple disconnected tools.",
  },
  {
    description: "Business lead generation platform for discovering local businesses.",
    problem: "Agencies needed a scalable way to identify businesses lacking digital presence.",
  },
  {
    description: "eSports platform with tournaments, brackets, teams, and gaming events.",
    problem: "Organizers needed a centralized platform for tournaments and event management.",
  },
  {
    description: "Fitness planning application with personalized workout routines.",
    problem: "Generic plans failed to adapt to individual fitness goals.",
  },
  {
    description: "Responsive eCommerce storefront with a modern shopping experience.",
    problem: "Small retailers needed an engaging online shopping platform.",
  },
] as const;
...
export const faqs = [
  ...
  },
  {
    ...
    a: "Every business is different, so we scope and quote per project after understanding what is actually needed. There is no fixed package - you only pay for what moves your business forward.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes - usually in the form of a chatbot handling enquiries, or automation quietly handling scheduling, reminders, and follow-ups in the background. It does not need to be complicated to be useful.",
  },
  {
